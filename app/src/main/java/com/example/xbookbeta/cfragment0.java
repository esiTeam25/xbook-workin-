...
public class cfragment0 extends Fragment {
    ...
    final GeoLocation center = new GeoLocation(FirstActivity.locationToUpload.latitude, FirstActivity.locationToUpload.longitude);
    List<GeoQueryBounds> bounds = GeoFireUtils.getGeoHashQueryBounds(center, 5*1000);
    RecyclerView rv ;
    Boolean end = false ;
